...
export default function Challenges() {
  ...
  const [challengeStatusTab, setChallengeStatusTab] = useState<'all' | 'open' | 'active' | 'pending' | 'finished'>('all');
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <Button
                  ...
                  className={cn(
                    "h-8 rounded-lg font-semibold text-xs transition-all",
                    createFormData.side === 'YES' ? "bg-green-500 text-white hover:bg-green-600" : "border-green-300 dark:border-green-700 text-green-700 dark:text-green-300 hover:bg-green-50 dark:hover:bg-green-950/30"
                  )}
                ...
                <Button
                  ...
                  className={cn(
                    "h-8 rounded-lg font-semibold text-xs transition-all",
                    createFormData.side === 'NO' ? "bg-red-500 text-white hover:bg-red-600" : "border-red-300 dark:border-red-700 text-red-700 dark:text-red-300 hover:bg-red-50 dark:hover:bg-red-950/30"
                  )}
